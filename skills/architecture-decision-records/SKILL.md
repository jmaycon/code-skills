...
description: Capture architectural decisions as structured ADRs. Auto-detects decision moments, records context, alternatives considered, and rationale. Maintains an ADR log so future developers understand why the codebase is shaped the way it is.
metadata:
  origin: jmaycon
---
...
Capture architectural decisions as they happen during coding sessions. this skill produces structured ADR documents that live at adrs folder.

## When to Activate

- User explicitly says "write an ADR"
...
Use the lightweight ADR format proposed by Maycon, adapted for AI-assisted development:

```markdown
---
tags:
  [Technology or related patterns key value pairs]
...
[1-3 sentences of the main rationale]
...
7. **Confirm and write** — present the draft ADR to the user for review. Only write to `docs/adr/yyyy-MM-dd-decision-title.md` after explicit approval. If the user declines, discard the draft without writing any files.
...
└── adr/
    ...
    ├── 2026-04-01-use-nextjs.md
    ├── 2026-04-02-postgres-over-mongo.md
    ├── 2026-04-03-rest-over-graphql.md
...
|-----|-------|--------|------|
| [2026-04-01](0001-use-nextjs.md) | Use Next.js as frontend framework | accepted | 2026-01-15 |
| [2026-04-02](0002-postgres-over-mongo.md) | PostgreSQL over MongoDB for primary datastore | accepted | 2026-01-20 |
| [2026-04-03](0003-rest-over-graphql.md) | REST API over GraphQL | accepted | 2026-02-01 |
```
...
```
proposed → accepted → [deprecated | superseded by ADR-yyyy-MM-dd]
```
